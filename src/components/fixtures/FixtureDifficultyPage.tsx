...
const FixtureDifficultyPage = ({ bootstrapData, fixtures }: FixtureDifficultyPageProps) => {
	...
	{/* Sticky bottom border — hugs the table when content is short, sticks to the
	    viewport bottom when scrolling. z-30 sits above the sticky left/right table cells (z-20). */}
	{view === 'grid' && (
