...
export const FixtureGridHeader = ({
	...
	return (
		...
		<TableHead
			className='sticky left-0 top-[length:var(--fixture-sticky-top,0px)] z-40 h-auto min-h-0 w-0 whitespace-nowrap bg-background p-0 text-left align-top font-semibold lg:top-0'
		...
		>
			...
			{events.slice(firstGameweek - 1, firstGameweek - 1 + numberOfGameweeks).map((gw) => (
				<TableHead
					key={gw.id}
					className='sticky top-[length:var(--fixture-sticky-top,0px)] z-30 min-w-[68px] bg-background text-center font-semibold sm:min-w-[92px] md:w-auto md:min-w-0 lg:top-0'
				>
		...
		<TableHead
		className='sticky right-0 top-[length:var(--fixture-sticky-top,0px)] z-40 h-auto min-h-0 w-[90px] border-l border-border bg-background p-0 text-right align-top font-semibold lg:top-0'
